...
**Status:** **LOCKED** 2026-08-20 (grill + lean packs) — **M0–M4 all shipped 2026-08-20 (v1 client + Phase 1.5 server expose complete)**  
...
| **M4** | Expose `/mcp` + token UI + read tools | Phase 1.5; after client proven — ✅ shipped 2026-08-20 |
...
**M4 live-verified 2026-08-20** — see `DECISIONS.md`'s "MCP Tool Connections — M4" entry.
