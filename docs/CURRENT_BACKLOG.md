...
| **Scene Beat removal** | **Design locked 2026-07-21.** Doc: `docs/Scene_Beat_Removal_Design.md`. Remove inline Scene Beat generators (Alt+S, `SceneBeatNode`, `sceneBeats` table/API/export). **Keep Concrete Beats.** Migrate chapter JSON: `scene-beat` → plain paragraph with command text. Prompts `scene_beat` → `other`. Slices **SB0–SB8** (SB1 before drop table). **Not started.** P3 until promoted. |
...
| `docs/Scene_Beat_Removal_Design.md` | Remove Scene Beats (**locked** 2026-07-21); keep Concrete Beats; SB0–SB8 — P3, not started |
