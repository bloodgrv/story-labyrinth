...
### Story Timeline
- Design: `docs/Story_Timeline_Design.md` (design locked 2026-08-06) — **TL0-TL6 implemented (2026-08-07)**, TL7-TL12 still open à la carte
...
- **Not yet built:** AI propose/accept (TL7), opt-in chat chronology context (TL8), era/overview strip (TL9), export image (TL10), scanner hook + bulk suggest (TL11), Guide + polish (TL12)
