...
// Baked into the Docker image at build time by server/scripts/prefetchEmbeddingModel.mjs and
// re-pointed at here unchanged at runtime, with allowRemoteModels forced off below — the running
// container never reaches the network for this, regardless of how the image was built.
