...
// Labeled key/value attributes — shared by Appearance (Hair, Facial Features, Physique, etc —
// see a reference character sheet's "Physical Appearance" section) and Custom Fields (the "Core
// Identity" table: Age, Role, Aesthetic, etc). Same CodexCustomField shape either way.
function LabeledFieldsBox({ control, name, title, emptyHint, labelPlaceholder, valuePlaceholder }: LabeledFieldsBoxProps) {
